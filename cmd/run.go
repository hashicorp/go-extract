...
type CLI struct {
	...
	NoUntarAfterUncompression  bool             `short:"N" optional:"" default:"false" help:"Disable combined extraction of tar.gz."`
...
func Run(version, commit, date string) {
	...
	config := config.NewConfig(
		...
		config.WithNoUntarAfterUncompression(cli.NoUntarAfterUncompression),
