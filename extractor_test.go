...
// 			got := extract.matchesMagicBytes(test.data, test.offset, test.magicBytes)
...
// 	c := extract.NewConfig(extract.WithContinueOnError(false))
// 	td := &telemetry.Data{}
...
// 	c = extract.NewConfig(extract.WithContinueOnError(true))
