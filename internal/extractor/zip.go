...
func UnpackZip(ctx context.Context, t Target, dst string, src io.Reader, c *config.Config) error {
...
func unpackZip(ctx context.Context, t Target, src seekerReaderAt, dst string, cfg *config.Config, m *telemetry.Data) error {
