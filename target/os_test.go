...
// 			// perform actual test
// 			want := tc.expectError
// 			err := target.CreateDir(cfg, filepath.Join(testDir, tc.basePath), tc.newDir, cfg.CustomCreateDirMode())
// 			got := err != nil
// 			if got != want {
...
// 			want := tc.expectError
// 			err := target.CreateSymlink(cfg, testDir, tc.input.name, tc.input.target)
// 			got := err != nil
// 			if got != want {
...
// 	testDir := t.TempDir()
// 	target := &OS{}
// 	if err := target.CreateSymlink(config.NewConfig(), testDir, "foo", "bar"); err != nil {
// 		t.Errorf(err.Error())
// 	}
...
// 		t.Run(fmt.Sprintf("tc %d", i), func(t *testing.T) {
// 			want := tc.expectError
// 			err := target.CreateSymlink(tc.cfg, testDir, tc.input.name, tc.input.target)
// 			got := err != nil
// 			if got != want {
// 				t.Errorf("test case %d failed: %s\n%s", i, tc.name, err)
// 			}
...
// 			target := &OS{}
// 			want := tc.expectError
// 			err := target.CreateFile(tc.config, testDir, tc.input.name, tc.input.reader, tc.input.mode)
// 			got := err != nil
// 			if got != want {
// 				t.Errorf("test case %d failed: %s\n%s", i, tc.name, err)
// 			}
...
// 			want := tc.expectError
// 			// double extract
// 			n1, err1 := target.CreateFile(tc.config, testDir, tc.input.name, tc.input.reader, tc.input.mode, -1)
// 			n2, err2 := target.CreateFile(tc.config, testDir, tc.input.name, tc.input.reader, tc.input.mode, -1)
